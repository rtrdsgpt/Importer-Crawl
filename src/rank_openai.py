"""
Phase 3 (OpenAI API variant).

Usage:
    export OPENAI_API_KEY=sk-...
    python src/rank_openai.py --input data/scraped_ceramic_tiles_germany.json \\
...
def main() -> None:
    parser = argparse.ArgumentParser(description="Rank scraped companies via OpenAI API.")
    ...
    parser.add_argument("--openai-key", default=None, help="Defaults to OPENAI_API_KEY env var")
    ...
    if not api_key:
        raise SystemExit("No OpenAI API key found. Set OPENAI_API_KEY in your environment or .env.")
